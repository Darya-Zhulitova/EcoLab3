 ...
 *
 * <сводка>
 *   Функция OnCombSortIterationStart
 * </сводка>
 *
 * <описание>
 *   Функция обратного вызова
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnCombSortIterationStart(/* in */ struct IEcoLab1Events* me, /* in */ size_t n, /* in */ int32_t iteration, /* in */ size_t gap) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    pCMe->m_iStep++;
    printf("Print from Sink. Step %d: CombSort iteration %ld started for array with size %d. Gap size %d\n", pCMe->m_iStep, n, iteration, gap);
 ...
 *
 * <сводка>
 *   Функция OnCombSortIterationComplete
 * </сводка>
 *
 * <описание>
 *   Функция обратного вызова
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnCombSortIterationComplete(/* in */ struct IEcoLab1Events* me, /* in */ size_t n, /* in */ int32_t iteration, /* in */ int32_t swaps_in_iteration) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    pCMe->m_iStep++;
    printf("Print from Sink. Step %d: CombSort iteration %ld completed for array with size %d. Iteration swap count %ld\n", pCMe->m_iStep, n, iteration, swaps_in_iteration);
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnCombSortComplete(/* in */ struct IEcoLab1Events* me, /* in */ size_t n, /* in */ int32_t swap_count) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    pCMe->m_iStep++;
    printf("Print from Sink. Step %d: CombSort completed for array with size %d. Total swap count %ld\n", pCMe->m_iStep, n, swap_count);
...
IEcoLab1VTblEvents g_x2D2E3B9214F248A6A09ECB494B59C795VTblEvents = {
    ...
    CEcoLab1Sink_OnCombSortStart,
    CEcoLab1Sink_OnCombSortIterationStart,
    CEcoLab1Sink_OnCombSortIterationComplete,
    CEcoLab1Sink_OnCombSortComplete
};
...
int16_t ECOCALLMETHOD createCEcoLab1Sink(/* in */ IEcoMemoryAllocator1* pIMem, /* out */ IEcoLab1Events** ppIEcoLab1Events) {
    ...
    /* Установка функций Advise и Unadvise */
